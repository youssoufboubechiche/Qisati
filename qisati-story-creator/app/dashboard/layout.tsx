...
import { BookOpen, Home, PenLine, LogOut, MessageSquare, Settings, User } from "lucide-react"
          ...
          <SidebarFooter className="border-t border-orange-200 p-4">
            <div className="flex items-center gap-3 rounded-xl p-3 hover:bg-orange-100">
              ...
              <div className="flex-1 overflow-hidden">
                ...
                <p className="truncate text-sm text-muted-foreground">parent@example.com</p>
              </div>
              <Button
                variant="ghost"
                size="icon"
